...
test('sign-in waits for MSAL readiness, another account is a fresh picker, and sign-out clears the cache before redirecting', () => {
  // signIn awaits MSAL readiness before loginRedirect
  {
  ...
  // authReady waits for both the memoized init and the warmed authority metadata
  {
  ...
  // Sign in as another account is a fresh authentication attempt: the picker is asked for, and the library picks nobody itself
  {
