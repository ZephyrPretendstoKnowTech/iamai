...
export const COLLECTOR_REGISTRY: CollectorSpec[] = [
  ...
  { name: 'Auth methods', lane: 'A', sourceKey: 'authMethods', endpoint: '/users/{id}/authentication/methods and /users/{id}/authentication/fido2Methods ($batch of 20)', version: 'v1.0', scopes: ['UserAuthenticationMethod.Read.All'], requiredCapability: null, gate: 'inner generic-method failure marks that user unknown; a failed FIDO2 detail read leaves credential fields unresolved', purpose: 'Registered method inventory plus exact passkey model, AAGUID, type and attestation detail (values stripped; never phone numbers).' },
