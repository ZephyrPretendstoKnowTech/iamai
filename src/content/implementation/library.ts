 ...
 */
export const RUNTIME_META_KEYS = ['stepId', 'title', 'relationship', 'contentFile', 'requiredBindings', 'optionalBindings', 'projection', 'supportBlocks', 'verifiedSources', 'prerequisites', 'observation', 'impact', 'baselineAuthority', 'email'] as const
