 ...
 */
export const RUNTIME_META_KEYS = ['stepId', 'title', 'relationship', 'contentFile', 'requiredBindings', 'optionalBindings', 'resolvedEmptyBindings', 'projection', 'supportBlocks', 'verifiedSources', 'prerequisites', 'observation', 'impact', 'milestone', 'baselineAuthority', 'email'] as const
