...
test('every condition operator evaluates deterministically, and the validator refuses unknown operators, undeclared bindings and prerequisites, and prose', () => {
  // every operator evaluates deterministically over state, bindings, prerequisites and the pin
  {
  ...
  // the validator refuses unknown operators, undeclared bindings and prerequisites, and prose
  {
...
test('the script’s own param() block is read, and an invocation that names a parameter the script lacks, or leaves the mode unnamed, is refused', () => {
  // the script’s own param() block is read: names and which are mandatory
  {
  ...
  // an invocation that names a parameter the script lacks, or leaves the mode unnamed, is refused
  {
