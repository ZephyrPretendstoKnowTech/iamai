...
export type EngineWords = {
  ...
  readiness: { notMeasured: string; measureStrength: Record<string, string>; strengthUnnamed: string; blind: string; blindFix: string; blindFixLicensed: string; activityUnreadLabel: string; activityUnreadValue: string; activityUnread: string; routeShortfallNone: string; routeShortfallSome: string; noneJudged: string; noneJudgedOne: string; methodLine: string; methodLineUnknown: string; methodLineStale: string; methodLineOff: string; methodLineOffAll: string; deviceComputers: string; deviceBoth: string }
