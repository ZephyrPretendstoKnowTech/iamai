...
export type EngineWords = {
  ...
  readiness: { notMeasured: string; blind: string; blindFix: string; blindFixLicensed: string; routeShortfallNone: string; routeShortfallSome: string; noneJudged: string }
