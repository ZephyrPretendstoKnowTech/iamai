...
import { cardFactOf, cardWordsOf, drawsTaskAnatomy, policyBarOf, policySubjectsOf, taskSubjectOf } from './policyTasks.ts'
...
export function ContentStep({
  ...
  const taskSubjects = isOwnTaskStep ? policySubjectsOf(contract, displayedReadiness, emergencyAccountTasks, taskSubjectOf(step, eyebrow, title), cardWordsOf(step)?.check ?? null, cardFactOf(step, ex)) : emergencySubjectsOf(displayedReadiness, emergencyAccountTasks)
