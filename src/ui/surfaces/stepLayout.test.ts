...
test('U3: the milestone sub-line is the package’s actionText or nothing, never generated', () => {
  ...
  assert.deepEqual(railOf(undated), { metric: lane.label, sub: '' })
  assert.deepEqual(railOf(undated, 'Create and verify two emergency accounts'), { metric: lane.label, sub: 'Create and verify two emergency accounts' })
