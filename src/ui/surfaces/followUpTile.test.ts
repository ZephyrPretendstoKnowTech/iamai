...
test('nobody marked: no step draws the tile', () => {
...
test('the campaign names everyone marked and says the waiting policies can go ahead', () => {
...
test('while anybody else is still not ready, the campaign does not say the policies can go ahead', () => {
...
test('a policy that asks for a method says each must register one at their next sign-in', () => {
...
test('a risk policy says Entra blocks them on a risky sign-in until they register a method', () => {
