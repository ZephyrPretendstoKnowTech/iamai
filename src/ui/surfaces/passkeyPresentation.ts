...
export const PASSKEY_METHODOLOGY = [
  'The default recommendation keeps Microsoft Authenticator for iOS and Android and the two pinned YubiKey 5 models available; saved additional models extend that intent.',
