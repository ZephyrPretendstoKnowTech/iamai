...
test('approved passkey models are canonical, and only an explicit confirmed deviation sets or clears them', () => {
  // additional authenticator input is canonical, named and deduplicated by model GUID
  {
  ...
  // only an explicit confirmed deviation authorizes models; clearing is explicit too
  {
