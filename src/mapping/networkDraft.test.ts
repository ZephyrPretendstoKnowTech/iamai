...
test('a saved proposed network is a draft, never everyone remote or an Entra object, and its ranges are valid CIDR short of the whole internet', () => {
  // a saved proposed network is not confused with everyone remote or an existing Entra object
  {
  ...
  // draft ranges require valid CIDR syntax and cannot cover the whole internet
  {
