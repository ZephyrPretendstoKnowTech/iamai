...
import { countryName, suggestCountries } from './countries.ts'
...
test('service accounts: name pattern plus evidence is a candidate; excluded ids never surface; the question hides when nothing is found', () => {
  // service accounts: name pattern plus evidence is a candidate; a normal person is not
  {
  ...
  // service accounts: excluded ids and guests never surface; the question hides when nothing is found
  {
