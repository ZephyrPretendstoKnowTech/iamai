...
// R4-57 / R4-52 residual. On the large tenant the Affected people tile read
// "4,169 active people · 51 admins · 197 guests · covers 4900 enabled", and the
// campaign's lead "3981 people and 197 guests": the head went through count()
// and carried a separator, the enabled total and the cohort words did not.
test('every number on the population line and in the cohort words carries its separator', () => {
