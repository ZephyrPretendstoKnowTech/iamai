...
test('first-party apps resolve by name, and a tenant\'s own app name beats the baseline\'s label', () => {
  // Azure Virtual Desktop and Windows 365 resolve, and the phrase is gone
  {
...
test('a display name two accounts share is told apart, account lists carry the address, and no two people render as one name', () => {
  // a display name two accounts share is told apart, and a name nobody shares is left alone
  ...
  // an account list reads the same rule, with the address on every account
