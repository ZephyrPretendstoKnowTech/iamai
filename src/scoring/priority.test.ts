...
test('scoreGoal: size bands (A3), value, effort, disruption and priority', () => {
  ...
  // effort: base plus prerequisites, new objects, readiness gap; capped; enforced is 1.
  ...
  // disruption: everyone affected by a block in a large tenant is 5; readiness and clean evidence pull it down; nobody affected is 1.
  ...
  // priority = value × (6 − disruption), ties by lower effort.
