...
import { REQUEST_HOSTS as CSP_REQUEST_HOSTS } from '../scripts/csp.ts'
...
// The list is the one the published Content-Security-Policy allows (scripts/csp.ts).
const REQUEST_HOSTS = new Set<string>(CSP_REQUEST_HOSTS)
