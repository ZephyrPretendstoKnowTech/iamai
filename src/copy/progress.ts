...
export const PROGRESS = {
  ...
  journeyHint: 'Each dot is a step, coloured by its current ring; the band reads left to right from planned to verified.',
...
export const EXPORT_TAB = {
  ...
  changeRecordText: 'One entry per step: what changed, when, by which step, and the evidence that moved it. For the change board.',
  downloadChangeRecord: 'Download the change record',
  markdown: 'Markdown',
