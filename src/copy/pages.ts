...
export const SCAN = {
  ...
  readingConfig: (done: number, total: number, elapsed: string | null) =>
    `Reading configuration and inventory (${done} of ${total})${elapsed ? ` · ${elapsed} elapsed` : ''}`,
...
export const LICENSING = {
  ...
  next: 'Next: run a scan to score these goals for the tenant',
