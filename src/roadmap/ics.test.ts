...
test('a folded line never exceeds 75 octets, never splits a character, and unfolds to what it was; a short line is left alone', () => {
  // a folded line never exceeds 75 octets, never splits a character, and unfolds to what it was
  {
