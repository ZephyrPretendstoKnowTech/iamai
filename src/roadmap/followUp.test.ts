...
test('the campaign is open with nobody turned on without, and marking everyone not ready finishes it and stops the board holding its policies on it', () => {
  // the premise: the campaign is open, and nothing is turned on without anybody
  {
  ...
  // marking everyone not ready finishes the campaign, and the board stops holding its policies on it
  {
...
test('each policy that waited on the campaign names the marked people its policy reaches, and nobody who has since become ready', () => {
  // each policy that waited on the campaign names the marked people its policy reaches
  {
    const missing = campaignOf(runFixture(base()).steps).preparation!.missingIds
  ...
  // somebody marked who has since become ready is no longer turned on without
  {
