# Walk of build 175f7e4 — demo tenant, 2026-09-02
...
offline. Captures and screenshots under `walk/175f7e4/` (not committed).

Verdict: not show-ready: 1 P0. 6 P1, 22 P2.
...
First load of the demo on a throttled connection (Fast 3G, the production bundle served statically): 2.9 s to the first plan row. Readiness values seen: demo: admin 60% · mfa 36% · device 30%; demo-week2: admin 60% · mfa 45% · device 30%. Active-people counts seen: demo 33; demo-week2 33. Learn links checked: 16.
