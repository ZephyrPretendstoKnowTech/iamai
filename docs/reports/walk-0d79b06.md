# Walk of build 0d79b06 — demo tenant, 2026-09-02
...
offline. Captures and screenshots under `walk/0d79b06/` (not committed).

Verdict: show-ready on this walk (no P0). 5 P1, 20 P2.
...
3. demo-week2 @1280 step "Create or Correct Service Accounts Group": row "svc-mailer-1 · name contains "svc"; no MFA method registered; uses legacy authen…" is 1 sentences / 33 words, over 2 / 30
4. Learn link https://learn.microsoft.com/entra/identity/users/users-inactive answers 404
5. Learn link https://learn.microsoft.com/entra/identity/conditional-access/policy-admin-phishing-resistant-mfa answers 404
...
10. demo-week2 @1280 step "Create and Enforce the MFA Registration Campaign": (contract question) row "People who need special care Casey Kim · No method Quinn Ivanova · Never prompte…" is 1 sentences / 64 words, over 2 / 30
11. demo-week2 @1280 step "Create and Enforce the MFA Registration Campaign": (contract question) row "CopyHi everyone,From Tuesday, September 8, signing in to Contoso Pty Ltd will as…" is 5 sentences / 107 words, over 2 / 30
12. demo-week2 @1280 step "Shorten Admin Sessions": (contract question) row "CopyAdmins,From Wednesday, September 9, admin sessions at Contoso Pty Ltd expire…" is 2 sentences / 38 words, over 2 / 30
13. demo-week2 @1280 step "Block Sign-ins From Countries Not Allowed": (contract question) row "CopyHi everyone,From Wednesday, September 9, sign-ins to Contoso Pty Ltd from ou…" is 3 sentences / 40 words, over 2 / 30
14. demo-week2 @1280 step "Require a Managed Device for Office 365": (contract question) row "CopyHi everyone,From Monday, September 21, Contoso Pty Ltd mail, files and Teams…" is 3 sentences / 47 words, over 2 / 30
15. demo-week2 @1280 step "Limit How Long Sessions Last": (contract question) row "CopyHi everyone,From Monday, September 28, when you close your browser you are s…" is 2 sentences / 57 words, over 2 / 30
16. demo-week2 @1280 step "Require Token Protection on Windows": (contract question) row "CopyHi,From Monday, September 28, Outlook, Teams and OneDrive on your Windows co…" is 3 sentences / 53 words, over 2 / 30
17. demo-week2 @1280 step "Protect Sign-in Method Registration": (contract question) row "CopyHi everyone,From Wednesday, September 9, setting up or changing your sign-in…" is 3 sentences / 40 words, over 2 / 30
