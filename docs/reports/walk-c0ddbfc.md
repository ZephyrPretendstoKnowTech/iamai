# Walk of build c0ddbfc — demo tenant, 2026-09-02
...
offline. Captures and screenshots under `walk/c0ddbfc/` (not committed).

Verdict: not show-ready: 1 P0. 6 P1, 22 P2.

## P0 — wrong or broken facts on screen

1. demo-week2: the exclusions-group step still renders in week two, although the re-scan recognised the group
