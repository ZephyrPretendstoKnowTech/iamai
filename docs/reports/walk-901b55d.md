# Walk of build 901b55d — demo tenant, 2026-09-02
...
offline. Captures and screenshots under `walk/901b55d/` (not committed).

Verdict: not show-ready: 2 P0. 6 P1, 22 P2.

## P0 — wrong or broken facts on screen

1. demo: the active-people count reads 30 and 29 and 33 across surfaces (one population)
2. demo-week2: the active-people count reads 30 and 29 and 33 across surfaces (one population)
...
First load of the demo on a throttled connection (Fast 3G, the production bundle served statically): 2.7 s to the first plan row. Readiness values seen: demo: admin 60% · mfa 36% · device 30%; demo-week2: admin 60% · mfa 45% · device 30%. Active-people counts seen: demo 30/29/33; demo-week2 30/29/33. Learn links checked: 15.
