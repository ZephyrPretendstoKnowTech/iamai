# Walk of build 404a051 — demo tenant, 2026-09-02
...
offline. Captures and screenshots under `walk/404a051/` (not committed).

Verdict: not show-ready: 4 P0. 3 P1, 20 P2.
...
3. demo-week2 @1280 step "Block the Admin Portals for Non-Admins": forbidden phrase "an unnamed account"
4. demo-week2 @1280 step "Block Sign-ins From Countries Not Allowed": forbidden phrase "an unnamed account"
