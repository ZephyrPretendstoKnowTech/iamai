# Walk of build 4a0229f — demo tenant, 2026-09-02
...
offline. Captures and screenshots under `walk/4a0229f/` (not committed).

Verdict: not show-ready: 1 P0. 9 P1, 22 P2.

## P0 — wrong or broken facts on screen

1. demo @1280 /connect: forbidden string "confirm" on the surface (connect.scanned forbid)
...
4. demo @1280 /connect: heading "Contoso Pty Ltd" is not in the connect.scanned contract's allow list
5. demo @1280 /connect: button "Scan tenant" is not in the connect.scanned contract's allow list
6. demo @1280 /connect: page prose 8 sentences / 113 words, over the connect.scanned budget 6 / 100
7. demo-week2 @1280 step "Create or Correct Service Accounts Group": row "svc-mailer-1 · name contains "svc"; no MFA method registered; uses legacy authen…" is 1 sentences / 33 words, over 2 / 30
8. Learn link https://learn.microsoft.com/entra/identity/users/users-inactive answers 404
9. Learn link https://learn.microsoft.com/entra/identity/conditional-access/policy-admin-phishing-resistant-mfa answers 404
