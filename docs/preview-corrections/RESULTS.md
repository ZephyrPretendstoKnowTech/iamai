...
- C07: 24 STEP.md references (18 tied to the C02 lifecycle decision); IN PROGRESS, "nothing is enforced yet", Ready-with-prerequisites and crosslink items not reproduced; register-info-protected `blockOutsideTrusted` and admin-session staging lines unchanged (BLOCKED S3).
