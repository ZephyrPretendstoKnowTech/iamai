<!-- source-fingerprint: fd7336e20ab21aee -->
# UI inventory
...
- Must fix first: 14 steps that can deny access are held until it passes.
- about 16 minutes
- nothing blocks it, and 2 later steps wait for it
- about 10 minutes
...
Words: **1676** — headings 117, prose 777, buttons 51, options 0, links 630, chips 37, columns 4, tiles 6, tips 15.
