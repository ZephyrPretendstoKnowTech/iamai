...
|---|---|---|---|
| ~~D1~~ done 2026-08-28 | audit-01 | Fixture user "Jordan Kim (guest)" shows the guest chip next to a name that already says "(guest)". | The synthetic tenant's display name contains the word; real tenants do not. Renaming the fixture user changes screenshots in `docs/screens/`. |
