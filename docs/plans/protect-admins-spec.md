...
| Enforced / in place | Require Phishing-Resistant MFA for Admins, follow-up | «Completed · Enforced», reason «Satisfied by Core - Grant - Admins phishing-resistant — no change needed», the Entra task is the compare-and-confirm procedure. |
